...
{
    public class EuropeTires : Tires
    {
        public EuropeTires(string Name, int Price, double Control, double Acceleration, double TireLife) : base(Name, Price, Control, Acceleration, TireLife) { }
