...
{
    public class JapanTires : Tires
    {
        public JapanTires(string Name, int Price, double Control, double Acceleration, double TireLife) : base(Name, Price, Control, Acceleration, TireLife) { }
